...
/// - Note: Piggy bank can't hold more than 255 pennies and less than 0
class PiggyBank {
    ...
    /// - Note: Deposit must be less than 256
    ...
    /// - Note: Withdraw can't be less than 0
...
var bank2 = PiggyBank()
bank2.deposit(pennies: 255) // This is maximum amount of deposit
//bank2.deposit(pennies: 1) // This cause overflow
bank2.withdraw(pennies: 255) // This is maximum amount of withdraw
//bank2.withdraw(pennies: 1) // This cause overflow
